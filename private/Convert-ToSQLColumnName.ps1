function Convert-ToSQLColumnName{
    <#
        ...
        .SYNOPSIS
        Convert-ToSQLColumnName intakes a variable and ensures it is a PowerShell comaptible string. It then formats it for use as a Column Name for an SQL Query
